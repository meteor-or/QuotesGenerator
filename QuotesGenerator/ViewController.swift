...
//  QuotesGenerator
//
//  Created by lee yuseong on 2022/06/14.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func tabQuoteGeneraterBtn(_ sender: Any) {
        
        let random_ = Int (arc4random_uniform(5))// 0 ~ 4 사이의 난수를 생성
        let quote = quotes[random_]
